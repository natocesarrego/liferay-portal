...
<div class="row">
	<div class="col-md-12">
		...
		<aui:select label="site-navigation-locale-prepend-friendly-url-configuration-name" name="localePrependFriendlyUrlStyle" required="<%= true %>" type="text" value="<%= siteNavigationLocalePrependFriendlyUrlConfiguration.localePrependFriendlyUrlStyle() %>">
