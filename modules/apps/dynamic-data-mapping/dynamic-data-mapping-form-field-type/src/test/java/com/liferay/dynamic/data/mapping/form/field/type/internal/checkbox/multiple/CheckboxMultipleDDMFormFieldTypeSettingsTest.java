...
public class CheckboxMultipleDDMFormFieldTypeSettingsTest
	...
	@Test
	public void testCheckboxMultipleDDMFormFieldTypeSettingsDDMFormLayout() {
		...
		for (DDMFormLayoutRow ddmFormLayoutRow :
			...
			for (DDMFormLayoutColumn ddmFormLayoutColumn :
				...
				Assert.assertEquals(
					"showAsSwitcher", ddmFormFieldNamesColumnBasic.get(3));
				Assert.assertEquals(
		...
		for (DDMFormLayoutRow ddmFormLayoutRow :
			...
			for (DDMFormLayoutColumn ddmFormLayoutColumn :
				...
				Assert.assertEquals(
					"predefinedValue", ddmFormFieldNamesColumnAdvanced.get(2));
				Assert.assertEquals(
