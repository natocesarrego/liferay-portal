...
HttpServletResponse httpServletResponse = PipingServletResponse.createPipingServletResponse(pageContext);

ddmFormAdminDisplayContext.setHttpServletResponse(httpServletResponse);
