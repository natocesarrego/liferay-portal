...
public abstract class BaseTemplateUpgradeProcessTestCase {
	...
	protected DDMTemplate addDDMTemplate(String filePath) throws Exception {
	...
	protected FragmentEntry addFragmentEntry(String filePath) throws Exception {
	...
	protected DDMTemplate getDDMTemplate(long templateId) throws Exception {
		return _ddmTemplateService.getTemplate(templateId);
	}

	protected FragmentEntry getFragmentEntry(long fragmentEntryId)
		throws Exception {
