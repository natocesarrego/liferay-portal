...
public class DDMIndexerImpl implements DDMIndexer {
	...
	protected Object[] getValuesAsArray(
		...
		if (valueType.equals(FieldConstants.DATE)) {
			values = valuesStrings.toArray(new Date[valuesStrings.size()]);
		}
		else if (valueType.equals(FieldConstants.INTEGER)) {
			values = valuesStrings.toArray(new Integer[valuesStrings.size()]);
		}
		else if (valueType.equals(FieldConstants.LONG)) {
			values = valuesStrings.toArray(new Long[valuesStrings.size()]);
		}
			...
			values = valuesStrings.toArray(new String[valuesStrings.size()]);
		}
