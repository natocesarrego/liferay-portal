 ...
 */
public class UpgradeJavaGetImagePreviewURLMethodCheck extends BaseFileCheck {
	...
	protected String doProcess(
		...
		while (getImagePreviewURLMatcher.find()) {
			String methodCall = JavaSourceUtil.getMethodCall(
				content, getImagePreviewURLMatcher.start());

			content = StringUtil.replace(
				content, methodCall,
				StringUtil.replace(
					methodCall, "DLUtil.getImagePreviewURL(",
