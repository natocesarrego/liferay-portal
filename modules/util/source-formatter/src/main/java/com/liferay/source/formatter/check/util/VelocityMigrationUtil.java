...
public class VelocityMigrationUtil {
	...
	public static String getFTLContentMigrated(
			String content, String velocityFileName)
		throws IOException {

		File file = _getMigratedFTLFile(velocityFileName);

		String contentFTL = content;

		if (file.length() != 0) {
			contentFTL = FileUtil.read(file);
		}
	...
	public static void writeMigratedContent(
		...
		FileUtil.write(_getMigratedFTLFile(velocityFileName), migratedContent);
	}
