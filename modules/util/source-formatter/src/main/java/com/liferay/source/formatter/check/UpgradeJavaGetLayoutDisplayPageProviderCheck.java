...
public class UpgradeJavaGetLayoutDisplayPageProviderCheck
	...
	protected String doProcess(
		...
		return _checkForGetLayoutDisplayPageProvider(content, javaClass);
	}

	private String _checkForGetLayoutDisplayPageProvider(
		...
		for (JavaTerm childJavaTerm : javaClass.getChildJavaTerms()) {
			...
			Matcher matcher = _getLayoutDisplayPageProviderPattern.matcher(
				javaMethodContent);
	...
	private static final Pattern _getLayoutDisplayPageProviderPattern =
		Pattern.compile(
