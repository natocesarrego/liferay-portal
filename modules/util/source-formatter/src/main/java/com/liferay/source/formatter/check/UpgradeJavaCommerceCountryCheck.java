 ...
 */
public class UpgradeJavaCommerceCountryCheck extends BaseFileCheck {
	...
	protected String doProcess(
		...
		Matcher matcher = _twoOrThreeLettersISOCodePattern.matcher(content);
	...
	private static final Pattern _twoOrThreeLettersISOCodePattern =
		Pattern.compile(
			"(\\w+)\\.\\w*\\(?\\s*\\)?\\s*\\.?" +
