 ...
 */
public class UpgradeJavaAddLayoutParameterCheck extends BaseFileCheck {
	...
	protected String doProcess(
		...
		Matcher addLayoutMatcher = _addLayoutPattern.matcher(content);

		while (addLayoutMatcher.find()) {
			String methodCall = JavaSourceUtil.getMethodCall(
				content, addLayoutMatcher.start());
	...
	private static final Pattern _addLayoutPattern = Pattern.compile(
		"\\t*?\\w+\\.addLayout\\(");
