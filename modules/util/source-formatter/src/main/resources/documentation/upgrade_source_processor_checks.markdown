# Checks for .bnd, .gradle, .java, .jsp or .vm
...
UpgradeJavaOnAfterUpdateParameterCheck | [Upgrade](upgrade_checks.markdown#upgrade-checks) | Fill in the new parameter of the method 'onAfterUpdate' of ModelList class |
