...
UpgradePortletDisplayCheck | .bnd, .ftl, .gradle, .java, .jsp, .jspf, .scss or .vm | Replaces 'portletDisplay.getPortletInstanceConfiguration' with 'ConfigurationProviderUtil.getPortletInstanceConfiguration' |
