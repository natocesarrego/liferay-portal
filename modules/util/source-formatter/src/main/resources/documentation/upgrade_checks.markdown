...
UpgradeJavaSetResultsAndTotalCheck | .bnd, .gradle, .java or .vm | Run code migration of method searchContainer.setResults to the searchContainer.setResultsAndTotal and delete searchContainer.setTotal |
