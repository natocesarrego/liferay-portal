...
UpgradeJavaSchedulerEntryImplConstructorCheck | .bnd, .ftl, .gradle, .java, .jsp, .jspf or .vm | Replace constructors that use the empty constructor of the SchedulerEntryImpl class. |
