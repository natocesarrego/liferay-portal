...
UpgradeVelocityMacroMigrationCheck | .bnd, .gradle, .java or .vm | Run code migration of references to Macro statement from a Velocity file to a Freemarker file with the syntax replacements |
