...
UpgradeJavaGetFileMethodCheck | .bnd, .gradle, .java or .vm | Run code migration of method from 'getFile' to 'getFileAsStream', and include a method 'FileUtil.createTempFile(inputStream)' |
