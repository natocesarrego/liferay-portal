...
UpgradeVelocityVariableMigrationCheck | .bnd, .gradle, .java or .vm | Run code migration of set variables from a `velocity` file to a `fremarker` file with the syntax replacements |
