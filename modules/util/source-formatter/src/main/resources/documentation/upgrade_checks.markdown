...
UpgradeJavaGetImagePreviewURLMethodCheck | .bnd, .gradle, .java or .vm | Replaces the references of the method 'DLUtil.getImagePreviewURL' with the method 'getImagePreviewURL' of 'DLURLHelper' class |
