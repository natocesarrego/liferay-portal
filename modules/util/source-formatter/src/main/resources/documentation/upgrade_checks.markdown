...
UpgradeGetQuantityMethodCheck | .bnd, .ftl, .gradle, .java, .json, .jsp, .jspf, .scss or .vm | Run code to send a message when find the 'getQuantity' method from 'commerceOrderItem'. |
