...
UpgradeJavaHashUtilImportCheck | .bnd, .ftl, .gradle, .java, .jsp, .jspf or .vm | Replace the import 'com.liferay.portal.kernel.util.HashUtil' by 'com.liferay.petra.lang.HashUtil' |
