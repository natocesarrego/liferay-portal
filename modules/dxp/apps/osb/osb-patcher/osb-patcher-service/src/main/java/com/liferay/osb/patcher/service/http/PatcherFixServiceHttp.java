...
public class PatcherFixServiceHttp {
	...
	public static com.liferay.portal.kernel.json.JSONObject
		...
		try {
			MethodKey methodKey = new MethodKey(
				PatcherFixServiceUtil.class, "checkFixesByProjectVersion",
				_checkFixesByProjectVersionParameterTypes0);
	...
	private static final Class<?>[] _checkFixesByProjectVersionParameterTypes0 =
		new Class[] {String.class, String.class};

}
// LIFERAY-SERVICE-BUILDER-HASH:1129549061